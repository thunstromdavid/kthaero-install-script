...
apt-get install -y git meson ninja-build pkg-config gcc g++ systemd python3-pip chrony ufw cmake libsystemd-dev systemd-dev usb-modeswitch usb-modeswitch-data
